...
**falllback_font_name** | **str** | Gets or sets name of the font that will be used if no expected font is found in printer and built-in fonts collections. | [optional] 
