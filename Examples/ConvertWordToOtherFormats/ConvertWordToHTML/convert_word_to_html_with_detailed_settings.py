...
class Document(object):
	...
	def convertWordToHTML(self):
		...
		if(file_upload_response["Code"] == 200 and file_upload_response["Status"] == "OK"):
			dest_name = 'test_multi_pages.html'
			# For complete set of HTMLSaveOptions, please check https://docs.aspose.cloud/display/wordscloud/Convert+Document+to+Destination+Format+with+Detailed+Settings+and+Save+Result+to+Storage  
			save_options = asposewordscloud.HtmlSaveOptionsData(save_format='html', file_name=dest_name)
